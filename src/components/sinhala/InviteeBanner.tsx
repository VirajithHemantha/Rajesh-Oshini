...
export const InviteeBanner: React.FC<InviteeBannerProps> = ({ inviteeName }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <span className="text-brand-plum tracking-[0.2em] sm:tracking-[0.3em] text-[10px] sm:text-xs font-bold drop-shadow-sm font-sinhala-sans">
              විශේෂිත ආරාධිත අමුත්තා
            </span>
            <Sparkles className="w-4 h-4 text-brand-plum animate-pulse" />
          </div>

          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-sinhala-serif text-stone-800 tracking-tight mb-4 drop-shadow-sm">
            {inviteeName}
          </h2>
          ...
          <div className="flex items-center gap-4 justify-center max-w-xl mx-auto">
            ...
            <p className="text-stone-600 font-sinhala-serif italic text-lg sm:text-xl">
              අපගේ සුන්දර දිනය සැමරීමට <span className="text-brand-plum font-semibold">{
                inviteeName.endsWith("ඔබ දෙපළට") ? "ඔබ දෙපළට" :
                inviteeName.endsWith("ඔබ සැමට") ? "ඔබ සැමට" :
                "ඔබට"
              }</span> ගෞරවයෙන් ආරාධනා කරමු.
            </p>
