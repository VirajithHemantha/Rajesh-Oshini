          ...
          <AnimatePresence mode="wait">
            {status === 'success' ? (
              ...
              >
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-[0.2em] font-bold text-stone-500 mb-3 ml-2">පැමිණීම</label>
                  <div className="relative group">
                    ...
                    >
                      <option value="Accepted">සතුටින් සහභාගී වෙමි</option>
                      <option value="Declined">සහභාගී වීමට නොහැක</option>
                    </select>
